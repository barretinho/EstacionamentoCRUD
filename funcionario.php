...
<body>
    ...
    <div class="container">
        <div class="title-box">
            ...
            <span>Dados de todos os funcionários contratados pelo estacionamento.</span>
        </div>
        ...
        <div class="cards-box">
            <?php
                $todos = ListarFuncionários("");
                while ($func = $todos->fetch_object()) {
                    echo '
                        <div class="card">
                            ...
                            <div class="card-info">
                                ...
                                <p>'.$func->nm_funcionario.'</p>
                                <span>Email: </span>
                                <p>'.$func->email_funcionario.'</p>
                                <span>CPF: </span>
                                <p>'.$func->cpf_funcionario.'</p>
                                <span>Data de Nascimento: </span>                                
                                <p>'.$func->dt_nascimento.'</p>                                
                            </div>
                        </div>
                    ';
                }
